...
public class AdminView {
    ...
    @Autowired
    public AdminView(AdminService adminService, RestaurantService restaurantService,
                     LoginView loginView, FoodService foodService, CustomerService customerService) {
